...
\newglossaryentry{Smartphone}
{
	name=Smartphone,
	plural=Smartphones,
	description={Ein Mobiltelefon mit umfangreichen Computerfunktionalitäten und Konnektivitäten}
}
...
\newglossaryentry{Luftqualitaetsdatum}{
    name=Luftqualitätsdatum,
    plural=Luftqualitätsdaten,
...
\newglossaryentry{Standard-Hardware}
{
	...
	description={Hardware in technischen Geräten, die zum Zeitpunkt der Entwicklung der Software nicht älter als 5 Jahre ist},
}
...
\newglossaryentry{Standard-Browser}
{
	...
	description={Ein Browser mit nennenswerter Marktbeteiligung, der zum Zeitpunkt der Entwicklung der Software nicht älter als 5 Jahre ist}
}
...
{
	name=JavaScript,
	description={JavaScript ist eine Scriptsprache zur Ausführung im Webbrowser. Ursprünglich wurde JavaScript für das Laden von Seiten und Interaktion mit Nutzereingaben entwickelt. Heute findet JavaScript auch in größeren Strukturen Anwendung}
}
...
{
	name=Leaflet,
	description={Leaflet ist eine freie JavaScript-Bibliothek mit der Webanwendungen erstellt werden können. Die Bibliothek unterstützt die meisten Desktop- und Smartphone-Browser.}
}
